 ...
 */
async function fetchPendingPackages(offset) {
    ...
    while (true) {
        ...
        for (const pkg of batch) {
            ...
            try {
                ...
                console.error(`❌ Failed to update package id=${id} (${package_uid}):`, err?.message ?? err);
            }
        }
        offset += batch.length;
